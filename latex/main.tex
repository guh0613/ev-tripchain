...
\begin{document}
    ...
    IEEE 33 节点配电系统是配电网分析中广泛采用的标准测试算例，由 Baran 和 Wu[22] 在提出 DistFlow 潮流模型时首次使用。该系统为单电源辐射状配电网，额定电压 12.66 kV，包含 33 个节点和 32 条支路，节点 0 为变电站母线（平衡节点），其余 32 个节点为负荷节点。系统拓扑呈三分支树形结构：主馈线从节点 0 经节点 1—17 延伸至末端，两条分支馈线分别从节点 2 和节点 5 引出。此外，系统设有 5 条常开联络线，连接不同馈线分支的末端节点，为网络重构提供备选路径。
    ...
    \placeholderfigure{IEEE 33 节点配电网拓扑图}{fig:ieee33_topology}
    ...
    \placeholderfigure{硬约束与软指标双层评估体系结构图}{fig:dual_layer_assessment}
    ...
    \begin{figure}[htbp]
        ...
        \subfigure[（a）三阶段自适应二分搜索流程]{
            \includegraphics[width=0.46\textwidth]{fig3_4_p1.png}
        }
        \hfill
        \subfigure[（b）单次 $\hat{\pi}(N)$ 评估流程]{
            \includegraphics[width=0.46\textwidth]{fig3_4_p2.png}
        }
